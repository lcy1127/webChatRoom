...
$('#register').on('click', function () {
  //获取用户信息
  username = $('#register_username').val().trim()//删除空格的效果
  password = $('#register_password').val().trim()
  sex = $('#sex input[name=sex]:checked').val();
  avatar = $('#register_avatar li.now img').attr('src')//attr()可以对src进行获取或设置
    ...
    $('.box-bd').append(`
      <div class="message-box">
        <div class="my message">
          ...
          <div class="content">
            <div style="margin-bottom: 3px;text-align:center;font-size: 12px;color: #4f4f4f;">${data.time}</div>
            <div class="bubble">
